...
decltype (std::declval<Rule> () (
    std::declval<Interface::PeekableInputStream::T &> ()))
...
#define IO_Util_consume_hpp_2
    = typename std::enable_if<!std::is_void<typename std::invoke_result<Rule,
        Interface::PeekableInputStream::T &>::type>::value>::type
#endif /* IO_Util_consume_hpp_2 */
    >
typename std::invoke_result<Rule, Interface::PeekableInputStream::T &>::type
consume (Interface::PeekableInputStream::T & input_stream, Rule && rule)
{
