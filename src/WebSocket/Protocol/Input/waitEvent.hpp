void
T::waitEvent (IO::Interface::InputStream::T & input_stream, IO::CancelSignal::T & input_timeout_signal)
{
	try
	{
		{
			Thread::Timer::T input_timer (this -> input_timeout, &IO::CancelSignal::T::cancel, &input_timeout_signal);
